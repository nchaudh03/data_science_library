...
from data_science_library.src.hyperparameter.lightgbm_hyperparameter_search import (
    LightGBMHyperparameterSearch,
)
from data_science_library.src.hyperparameter.xgboost_hyperparameter_search import (
    XGBoostHyperparameterSearch,
)
...
def main():
    ...
    hp = LightGBMHyperparameterSearch(
        train_data=s.get_train_data(),
        valid_data=(s.get_test_data(), s.y_test),
        params=params,
        task=settings.SAMPLE_LOADER_TYPE,
    )
